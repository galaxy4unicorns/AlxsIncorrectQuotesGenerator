const quotesLibrary = {
  ...
  shipping: [
    ...
    { text: "<b> In the dorms late at night:<br><bbr>{Name A}<b>:</b> Love you, {Name B}<br><bbr>{Name B}<b>:</b> Love you too, {Name A}<br><bbr>{Name C}<b>:</b><br><bbr>{Name B}<b>:</b> we both love you as well, {Name C}<br><bbr>{Name C}<b>:</b> thanks, I was feeling left out", tags: ["shipping"] }, 
