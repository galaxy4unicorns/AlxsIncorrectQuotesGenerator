const quotesLibrary = {
  nothing: [ 
    ...
    { text: "{Name}<b>:</b> I hope no one lowkey hates me<br><bbr>{Name}<b>:</b> Highkey hate me, Hate me with every fiber of your being<br><bbr>{Name}<b>:</b> Go big or go home", tags: [] },
  ...
  swearing_shipping: [
    ...
    { text: "{Name A}, flirting with {Name B}<b>:</b> Has anyone ever told you how beautiful you are?<br><bbr>{Name B}, Oblivious<b>:</b> MotherfDucker do you think I don't already know that?<br><bbr>{Name A}<b>:</b><br><bbr>{Name B}<b>:</b> I don't need to be told", tags: ["shipping", "swearing"] },
